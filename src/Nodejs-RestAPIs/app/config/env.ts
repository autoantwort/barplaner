...
export default {
  ...
  ical: {
    ...
    location: undefined, //  "Turmstraße 1, 52072 Aachen, Germany", // or use appleLocation
    appleLocation: {
      // or use location
      title: "Symposion",
  ...
  webNotifications: {
    ...
    vapidKeys: {
      // in the src/Nodejs-RestAPIs folder execute "node_modules/web-push/src/cli.js generate-vapid-keys --json" to generate the keys
      publicKey: "",
      privateKey: "",
    },
