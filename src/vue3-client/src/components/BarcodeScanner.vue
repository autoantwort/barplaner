      ...
      if (this.barcodeDetector == null) {
        alert(
          'Barcode Detection API is not supported in this browser (Probably Safari or Firefox). ' +
            ...
            "On IOS you can for example use 'QRbot' (Settings ➔ Search Options) , on Android 'Qr & Barcode Scanner von Gamma Play' (Einstallungen ➔ Scrollen ➔ Kundenspezifische Maßnahme). Select 'Products' as category in both apps.",
        );
        return;
      }
