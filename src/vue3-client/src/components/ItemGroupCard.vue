<template>
  <b-card no-body class="border-info">
    ...
    <b-card-footer class="bg-info border-info"
      >A item group is a collection of items (e.g. orange juice as group for orange juice from differend brands). The minimum number should be at the minimum in
      the stock (e.g. the minimum is 2 and we only have one orange juice bottle in the stock, we get a warning that we have to buy orange juice. We should buy
      orange juice until we have the ideal number in stock.</b-card-footer
    >
  </b-card>
</template>
