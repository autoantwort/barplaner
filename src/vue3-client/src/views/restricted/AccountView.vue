    ...
    <div class="row mt-2">
      <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
        <form class="was-validated" id="form">
          ...
          <div>
            <b-form-checkbox id="active" v-model="user.active" name="active">
              <div class="text-black">Active Bar AG Member</div>
            </b-form-checkbox>
          </div>
          ...
          <div>
            ...
            >
              <div class="text-black">Only show GitLab notifications if assigned</div>
            </b-form-checkbox>
          </div>

          <br />

          <div class="mb-3" v-if="user.telegramID.indexOf('login') === 0">
      ...
      http
        ...
        .catch(e => {
          ...
          if (e.response.status === 400) {
            this.success = false;
            this.errorString = e.response.data.errors[0].type + ': ' + e.response.data.errors[0].message;
          }
        });
    },
  },
